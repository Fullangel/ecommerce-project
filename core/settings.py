...
DATABASES = {
    'default': env.db('DATABASES_URL', default='postgres:///ecommerce'),
}
...
if not DEBUG:
    # Correo desde donde se enviaran los correos a los usuarios
    DEFAULT_FROM_EMAIL = 'BYRON te saluda, Bienvenido a nuestra tienda <Byron@gmail.com>'
